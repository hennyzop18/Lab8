<?php
          ...
          $mail = new PHPMailer\PHPMailer\PHPMailer(true);  //true: enables exceptions
		    ...
		    $nguoigui = 'yenh53797@gmail.com';
		    $matkhau = 'bfxo cmdg jqlj fplh
            ';// mật khẩu của tài khoản
		    $tennguoigui = 'Hoàng Yến';
                $mail->Username = $nguoigui; // SMTP username
                $mail->Password = $matkhau;   // SMTP password
                $mail->SMTPSecure = 'ssl';  // encryption TLS/SSL 
                $mail->Port = 465;  // port to connect to                
                $mail->setFrom($nguoigui, $tennguoigui ); 
                $to = "khacduy584@gmail.com";
                $to_name = "khacduy";
                
                $mail->addAddress($to, $to_name); //mail và tên người nhận
                $mail->addAddress("nlquan@vku.udn.vn","lequan");
                // $recipients = "khacduy2002zz@gmail.com,khacduy2002zzz@gmail.com";
                ...
                $noidungthu = "<b>Chào bạn tôi là ".$nguoigui."!</b><br>Chúc an lành!" ;
